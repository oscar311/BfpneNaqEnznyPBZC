...
Timer0OVF: ; interrupt subroutine to Timer0
    ...
    cpi r26, low(1*INTS_PER_MS)                     ; 1ms check
    ...
    cpc r27, temp
    brne skipDisplay                                ; not 3 seconds yet
    ...
    cp currFlag, temp
    brne EndIF                                      ; if not, then done

    ldi temp, turnLEDOff                            ; else if, write individual bits to keep only motor on for longer
    out PORTE, temp
...
skipOff:
    ...
    ldi temp1, turnMotOn 
    out PORTE, temp1                                ; otherwise, turn motor on
